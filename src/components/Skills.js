...
import meter7 from "../assets/nextjs-removebg-preview.png";
import meter8 from "../assets/typescript-removebg-preview-removebg-preview.png"
import meter9 from "../assets/powerbi-removebg-preview.png";
...
const skills = [
    ...
    {
        id: 2,
        name: 'CSS ' + '(Bootstrap, Tailwind CSS)',
        imgs: meter5,
    },
    {
        id: 3,
...
const Skills = () => {
    return (
        <section className='section md:mt-40' id='Skills'>
            <div className="container mx-auto">
                <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 min-h-screen'>
                    <motion.div
                        ...
                        <h2 className='h2 text-accent mb-6 '>FRONTEND DEVELOPER</h2>
