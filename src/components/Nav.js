  ...
  return (
    <nav className='fixed bottom-2 lg:bottom-4 w-full overflow-hidden z-50'>
      <div className='container mx-auto '>
        ...
        <div className='w-full bg-black/20 h-[78px] backdrop-blur-2xl rounded-full max-w-[460px] mx-auto px-5 flex items-center justify-between text-2xl text-white/50'>
